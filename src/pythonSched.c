...
static PyMethodDef pythonSched_methods[] = {
    {"libanalyzethis_device_sched_init", py_device_sched_init, METH_VARARGS},
    {"libanalyzethis_device_sched_finalize", py_device_sched_finalize, METH_VARARGS},
    {"libanalyzethis_device_sched_task", py_device_sched_task, METH_VARARGS},
    {"libanalyzethis_host_sched_init", py_host_sched_init, METH_VARARGS},
    {"libanalyzethis_host_sched_finalize", py_host_sched_finalize, METH_VARARGS},
    {"libanalyzethis_host_sched_task", py_host_sched_task, METH_VARARGS},
    {"libanalyzethis_host_sched_copy_file", py_host_sched_copy_file, METH_VARARGS},
    {"libanalyzethis_host_sched_move_file", py_host_sched_move_file, METH_VARARGS},
    {"libanalyzethis_meta_sched_init", py_meta_sched_init, METH_VARARGS},
    {"libanalyzethis_meta_sched_finalize", py_meta_sched_finalize, METH_VARARGS},
    {"libanalyzethis_meta_sched_task", py_meta_sched_task, METH_VARARGS},
};
